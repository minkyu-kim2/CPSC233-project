...
public class CategorySelectionPageController extends PageController {
	...
	// when the next button is clicked, a new form is loaded to add an item of various types
	...
	// selects the category of the item being edited. If a new item is being created, the default category is set to other
