...
public class ShoppingListPageController extends PageController {
	 ...
	 * ShoppingListPage. On clicking the button, the user is taken to the item
	...
	public void addNewItem(ActionEvent event) throws FileNotFoundException, IOException {
		...
		CategorySelectionPageController controller = (CategorySelectionPageController) loadPage(null,
	...
	/**
	 * This function is added as an event listener for every item and gets fired
	 * when the detail button is clicked. On clicking the button, the user is taken
	 * to the detail page for the item selected.
	 * 
	 * @param item
	 * @throws FileNotFoundException
	 * @throws IOException
	...
	/**
	 * This function fills the ShoppingListPage with the saved data as a
	 * ShoppingList object
	 * 
	 * @throws FileNotFoundException
	 * @throws IOException
